...
public class Test3_handling {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement mon=driver.findElement(By.xpath("(cmd//span[@class='ui-datepicker-month'])[1]"));
		while(true) {
		...
		/*Thread.sleep(3000);
		String year="2020";
		WebElement mon1=driver.findElement(By.xpath("(//span[@class='ui-datepicker-year'])[1]"));
		while(true) {
